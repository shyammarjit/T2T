...
from .sincos_embd import get_2d_sincos_pos_embed
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def forward_vanilla(self, x):
        ...
        #print("From forward_vanilla",torch.isnan(x).any())
    ...
    def forward_encoder(self, x, mask_ratio):
        # embed patches
        x = self.patch_embed(x)
        #print("From forward_encoder",torch.isnan(x).any())
        #print(x)
